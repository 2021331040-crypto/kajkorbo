                              ...
                              >
                                {item.image && (
                                  <img
                                    ...
                                    onClick={() => setPreviewImage(item.image)} // Note: This line seems incomplete in the image, likely meant to set the preview image
                                  />
                                )}
                                <div>
                                  ...
                                  <p>
                                    ...
                                    {item.price}|<strong>Total Price:</strong> $
